...
namespace WpfFarmsActivity
{
    ...
    public partial class DiscountPointsEvent
    {
        ...
        {
            this.DiscountPointsEventDetail = new HashSet<DiscountPointsEventDetail>();
            this.DiscountPointsRec = new HashSet<DiscountPointsRec>();
        }
        ...
        public virtual ICollection<DiscountPointsEventDetail> DiscountPointsEventDetail { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<DiscountPointsRec> DiscountPointsRec { get; set; }
    }
}
